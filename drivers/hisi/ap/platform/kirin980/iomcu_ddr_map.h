...
#define DDR_IMAGE_SIZE (0x300000)
...
#define DDR_DUMP_BASE_AP DDR_HEAP_END_AP
...
#define DDR_DTB_BASE_AP DDR_FP_IMAGE_END_AP
#define DDR_DTB_SIZE (0x100000)
#define DDR_DTB_END_AP (DDR_DTB_BASE_AP + DDR_DTB_SIZE)
#define DDR_RESERVED_USED_END DDR_DTB_END_AP
