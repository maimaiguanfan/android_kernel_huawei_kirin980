...
#define M3_DDR_SYS_MEM_DATA_SEC_SIZE (0x5000)
#else
...
#define M3_DDR_STORAGE_MEM_UCE_RUNTIME_VAR_ADDR (M3_DDR_SHARE_MEM_DDR2FASTBOOT_BASE + M3_DDR_SHARE_MEM_DDR2FASTBOOT_SIZE)
#define M3_DDR_STORAGE_MEM_UCE_RUNTIME_VAR_SIZE (0x400)
#define M3_DDR_STORAGE_MEM_RESERVED_ADDR (M3_DDR_STORAGE_MEM_UCE_RUNTIME_VAR_ADDR + M3_DDR_STORAGE_MEM_UCE_RUNTIME_VAR_SIZE)
