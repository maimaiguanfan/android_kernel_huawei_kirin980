...
#define SOC_ACPU_LP_PCTRL_BASE_ADDR (0xFFF37000)
...
#define SOC_ACPU_GPIO29_BASE_ADDR (0xFFF2E000)
#define SOC_ACPU_AO_WDG_BASE_ADDR (0xFFF2D000)
#define SOC_ACPU_GPIO30_BASE_ADDR (0xFFF2B000)
...
#define SOC_ACPU_GPIO33_BASE_ADDR (0xFFF02000)
#define SOC_ACPU_GPIO32_BASE_ADDR (0xFFF01000)
#define SOC_ACPU_GPIO31_BASE_ADDR (0xFFF00000)
...
#define SOC_ACPU_IOMCU_I3C1_BASE_ADDR (0xFFD73000)
...
#define SOC_ACPU_IOMCU_I3C2_BASE_ADDR (0xFFD6A000)
...
#define SOC_ACPU_IOMCU_I3C3_BASE_ADDR (0xFFD64000)
...
#define SOC_ACPU_I2C6_BASE_ADDR (0xFDF0A000)
...
#define SOC_ACPU_SECENG_BASE_ADDR (0xFC1FE000)
#define SOC_ACPU_MMC1_SYS_CTRL_BASE_ADDR (0xFC186000)
...
#define SOC_ACPU_GIC_beeton_BASE_ADDR (0xEA000000)
#define SOC_ACPU_CFG_BLPWM_BASE_ADDR (0xE8A24000)
...
#define SOC_ACPU_NOC_ICS2_Service_Target_BASE_ADDR (0xE8910000)
...
#define SOC_ACPU_MEDAI2_LoadMonitor_BASE_ADDR (0xE8901000)
...
#define SOC_ACPU_MEDIA1_LoadMonitor_BASE_ADDR (0xE87FE000)
#define SOC_ACPU_NOC_VIVO_Service_Target_BASE_ADDR (0xE87D0000)
#define SOC_ACPU_NOC_IVP32_Service_Target_BASE_ADDR (0xE87C0000)
#define SOC_ACPU_NOC_ISP_Service_Target_BASE_ADDR (0xE87B0000)
#define SOC_ACPU_NOC_DSS_Service_Target_BASE_ADDR (0xE87A0000)
...
#define SOC_ACPU_SMMUv500_CFG_BASE_ADDR (0xE85F0000)
#define SOC_ACPU_ISP_R8_PERI_BASE_BASE_ADDR (0xE85EE000)
#define SOC_ACPU_ISP_TCMDMA_BASE_ADDR (0xE85E4000)
#define SOC_ACPU_ISP_SUB_CTRL_BASE_ADDR (0xE85E3000)
#define SOC_ACPU_ISP_IPC_BASE_ADDR (0xE85E2000)
#define SOC_ACPU_ISP_TIMER_BASE_ADDR (0xE85E1000)
#define SOC_ACPU_ISP_WDT_BASE_ADDR (0xE85E0000)
#define SOC_ACPU_ISP_Core_CFG_BASE_ADDR (0xE8400000)
#define SOC_ACPU_JPG_FD_BASE_ADDR (0xE8340000)
#define SOC_ACPU_JPG_SMMU_BASE_ADDR (0xE8320000)
#define SOC_ACPU_JPG_TOP_BASE_ADDR (0xE8304000)
#define SOC_ACPU_JPG_SMMU_MASTER_BASE_ADDR (0xE8303000)
#define SOC_ACPU_JPG_CVDR_BASE_ADDR (0xE8302000)
#define SOC_ACPU_JPG_DEC_BASE_ADDR (0xE8301000)
#define SOC_ACPU_JPG_ENC_BASE_ADDR (0xE8300000)
...
#define SOC_ACPU_SoundWire_BASE_ADDR (0xE8054000)
...
#define SOC_ACPU_SIO_CODEC_BASE_ADDR (0xE804F400)
...
#define SOC_ACPU_VIC_DSP0_BASE_ADDR (0xE0457000)
...
#define SOC_ACPU_SYSCTRL_MDM_BASE_ADDR (0xE0200400)
#define SOC_ACPU_CRG_MDM_BASE_ADDR (0xE0200000)
