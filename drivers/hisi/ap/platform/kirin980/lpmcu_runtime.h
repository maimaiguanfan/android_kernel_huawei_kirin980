...
#define CPU_PERI_NORM_LIMIT(n) (CPU_PERI_LIMIT(n) & 0xF)
#define CPU_PERI_HIGH_LIMIT(n) ((CPU_PERI_LIMIT(n) & 0xF0) >> 4)
...
#define RUNTIME_FCM_CNT_ADDR(n) (RUNTIME_VAR_BASE + 0x34 + ((n) * 4))
#define FCM_CNT_ADDR(n) BYTE_REF(RUNTIME_FCM_CNT_ADDR(n))
...
#define RUNTIME_GEN_VAR_END (RUNTIME_HISEE_DATA_ADDR)
