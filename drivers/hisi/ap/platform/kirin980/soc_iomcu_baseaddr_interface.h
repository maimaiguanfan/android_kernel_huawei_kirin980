...
#define SOC_IOMCU_BOOTROM_remap_BASE_ADDR (0x5FFF0000)
#define SOC_IOMCU_BOOTROM_BASE_ADDR (0x5FFE0000)
#define SOC_IOMCU_LPMCU_RAM_BASE_ADDR (0x5FF62000)
...
#define SOC_IOMCU_LP_PCTRL_BASE_ADDR (0x5FF37000)
#define SOC_IOMCU_PMU_I2C1_BASE_ADDR (0x5FF36000)
#define SOC_IOMCU_PERI_CRG_BASE_ADDR (0x5FF35000)
#define SOC_IOMCU_PMU_I2C0_BASE_ADDR (0x5FF33000)
...
#define SOC_IOMCU_GPIO29_BASE_ADDR (0x5FF2E000)
#define SOC_IOMCU_AO_WDG_BASE_ADDR (0x5FF2D000)
#define SOC_IOMCU_GPIO30_BASE_ADDR (0x5FF2B000)
#define SOC_IOMCU_SPI3_BASE_ADDR (0x5FF2A000)
#define SOC_IOMCU_GPIO19_BASE_ADDR (0x5FF29000)
#define SOC_IOMCU_GPIO18_BASE_ADDR (0x5FF28000)
#define SOC_IOMCU_SPMI_BASE_ADDR (0x5FF24000)
#define SOC_IOMCU_AO_IPC_NS_BASE_ADDR (0x5FF22000)
#define SOC_IOMCU_AO_IPC_S_BASE_ADDR (0x5FF21000)
#define SOC_IOMCU_AO_TZPC_BASE_ADDR (0x5FF20000)
#define SOC_IOMCU_AO_LoadMonitor_BASE_ADDR (0x5FF1F000)
...
#define SOC_IOMCU_GPIO33_BASE_ADDR (0x5FF02000)
#define SOC_IOMCU_GPIO32_BASE_ADDR (0x5FF01000)
#define SOC_IOMCU_GPIO31_BASE_ADDR (0x5FF00000)
...
#define SOC_IOMCU_IOMCU_I3C1_BASE_ADDR (0x5FD73000)
...
#define SOC_IOMCU_IOMCU_I3C2_BASE_ADDR (0x5FD6A000)
...
#define SOC_IOMCU_IOMCU_I3C_BASE_ADDR (0x5FD65000)
#define SOC_IOMCU_IOMCU_I3C3_BASE_ADDR (0x5FD64000)
#define SOC_IOMCU_IOMCU_TCP_RAM_BASE_ADDR (0x5FD51000)
#define SOC_IOMCU_IOMCU_TCP_CFG_BASE_ADDR (0x5FD50000)
#define SOC_IOMCU_ICS_BASE_ADDR (0x5F400000)
#define SOC_IOMCU_UFS_SYS_CTRL_BASE_ADDR (0x5F3E0000)
#define SOC_IOMCU_UFS_CFG_BASE_ADDR (0x5F3C0000)
#define SOC_IOMCU_SD3_BASE_ADDR (0x5F37F000)
#define SOC_IOMCU_IOC_MMC0_BASE_ADDR (0x5F37E000)
#define SOC_IOMCU_MMC0_SYS_CTRL_BASE_ADDR (0x5F37D000)
#define SOC_IOMCU_DP_CTRL_BASE_ADDR (0x5F340000)
#define SOC_IOMCU_USB3OTG_BC_BASE_ADDR (0x5F200000)
#define SOC_IOMCU_USB3OTG_BASE_ADDR (0x5F100000)
#define SOC_IOMCU_SOCP_BASE_ADDR (0x5F060000)
#define SOC_IOMCU_PSAM_BASE_ADDR (0x5F040000)
#define SOC_IOMCU_IPF_BASE_ADDR (0x5F038000)
...
#define SOC_IOMCU_I2C6_BASE_ADDR (0x5DF0A000)
...
#define SOC_IOMCU_SECENG_BASE_ADDR (0x5C1FE000)
#define SOC_IOMCU_MMC1_SYS_CTRL_BASE_ADDR (0x5C186000)
#define SOC_IOMCU_SDIO0_BASE_ADDR (0x5C183000)
#define SOC_IOMCU_IOC_MMC1_BASE_ADDR (0x5C182000)
#define SOC_IOMCU_PCIE0_APB_CFG_BASE_ADDR (0x5C180000)
#define SOC_IOMCU_PCIEPHY0_BASE_ADDR (0x5C000000)
#define SOC_IOMCU_PCIECtrl0_BASE_ADDR (0x54000000)
...
#define SOC_IOMCU_DMSS_BASE_ADDR (0x4A980000)
...
#define SOC_IOMCU_IVP32_HWA_CFG_BASE_ADDR (0x48D85000)
...
#define SOC_IOMCU_GIC_beeton_BASE_ADDR (0x48B00000)
#define SOC_IOMCU_CFG_BLPWM_BASE_ADDR (0x48A24000)
#define SOC_IOMCU_LoadMonitor1_BASE_ADDR (0x48A23000)
...
#define SOC_IOMCU_LoadMonitor0_BASE_ADDR (0x48A08000)
...
#define SOC_IOMCU_NOC_ICS_Service_Target_BASE_ADDR (0x48950000)
...
#define SOC_IOMCU_MEDAI2_LoadMonitor_BASE_ADDR (0x48901000)
#define SOC_IOMCU_MEDIA2_CRG_BASE_ADDR (0x48900000)
#define SOC_IOMCU_VENC_BASE_ADDR (0x48880000)
#define SOC_IOMCU_VDEC_BASE_ADDR (0x48800000)
#define SOC_IOMCU_MEDIA1_CRG_BASE_ADDR (0x487FF000)
#define SOC_IOMCU_MEDIA1_LoadMonitor_BASE_ADDR (0x487FE000)
#define SOC_IOMCU_NOC_VIVO_Service_Target_BASE_ADDR (0x487D0000)
#define SOC_IOMCU_NOC_IVP32_Service_Target_BASE_ADDR (0x487C0000)
#define SOC_IOMCU_NOC_ISP_Service_Target_BASE_ADDR (0x487B0000)
#define SOC_IOMCU_NOC_DSS_Service_Target_BASE_ADDR (0x487A0000)
#define SOC_IOMCU_MEDIA_COMMON_BASE_ADDR (0x48700000)
#define SOC_IOMCU_DSS_PROTECTED_BASE_ADDR (0x48690000)
#define SOC_IOMCU_DBCU0_SMMU_BASE_ADDR (0x48680000)
...
#define SOC_IOMCU_DPE_BASE_ADDR (0x4866F000)
...
#define SOC_IOMCU_DBCU0_MIF_BASE_ADDR (0x4860A000)
#define SOC_IOMCU_DBCU1_AIF_BASE_ADDR (0x48609000)
#define SOC_IOMCU_DBCU0_AIF_BASE_ADDR (0x48607000)
#define SOC_IOMCU_CMD_BASE_ADDR (0x48602000)
#define SOC_IOMCU_ASC1_BASE_ADDR (0x48601C00)
#define SOC_IOMCU_ASC0_BASE_ADDR (0x48601800)
#define SOC_IOMCU_DSI1_BASE_ADDR (0x48601400)
#define SOC_IOMCU_DSI0_BASE_ADDR (0x48601000)
#define SOC_IOMCU_MMBUF_CFG_BASE_ADDR (0x48600000)
#define SOC_IOMCU_ISP_R8_DTCM_BASE_ADDR (0x485D0000)
#define SOC_IOMCU_ISP_R8_ITCM_BASE_ADDR (0x485C0000)
#define SOC_IOMCU_SMMUv500_CFG_BASE_ADDR (0x485B0000)
#define SOC_IOMCU_ISP_R8_PERI_BASE_BASE_ADDR (0x48590000)
#define SOC_IOMCU_ISP_TCMDMA_BASE_ADDR (0x48584000)
...
#define SOC_IOMCU_JPG_FD_BASE_ADDR (0x48340000)
#define SOC_IOMCU_JPG_SMMU_BASE_ADDR (0x48320000)
#define SOC_IOMCU_JPG_TOP_BASE_ADDR (0x48304000)
#define SOC_IOMCU_JPG_SMMU_MASTER_BASE_ADDR (0x48303000)
#define SOC_IOMCU_JPG_CVDR_BASE_ADDR (0x48302000)
#define SOC_IOMCU_JPG_DEC_BASE_ADDR (0x48301000)
#define SOC_IOMCU_JPG_ENC_BASE_ADDR (0x48300000)
...
#define SOC_IOMCU_SIO_CODEC_BASE_ADDR (0x4804F400)
...
#define SOC_IOMCU_SECRAM0_BASE_ADDR (0x48000000)
#define SOC_IOMCU_SECRAM1_BASE_ADDR (0x47FC0000)
#define SOC_IOMCU_SECRAM_USB_AUDIO_BASE_ADDR (0x47F80000)
#define SOC_IOMCU_USB_AUDIO_BASE_ADDR (0x47F00000)
...
#define SOC_IOMCU_VIC_DSP0_BASE_ADDR (0x40457000)
...
#define SOC_IOMCU_SYSCTRL_MDM_BASE_ADDR (0x40200400)
#define SOC_IOMCU_CRG_MDM_BASE_ADDR (0x40200000)
