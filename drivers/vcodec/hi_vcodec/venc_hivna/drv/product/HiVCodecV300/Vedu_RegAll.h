...
// ******************************************************************************
#ifndef __C_UNION_DEFINE_VEDU_REG_HIVCODECV300_H__
#define __C_UNION_DEFINE_VEDU_REG_HIVCODECV300_H__
...
typedef union
{
	...
	struct
	{
		unsigned int    mem_ctrl_d1w2r    : 16  ; /* [15..0]  */
		unsigned int    Reserved_200      : 16  ; /* [31..16]  */
	} bits;
...
typedef union
{
	...
	struct
	{
		...
		unsigned int    vcpi_venc_mid_s        :1    ; /* [8] */
		unsigned int    Reserved_119    : 23  ; /* [31..9]  */
	} bits;
...
/* Define the union U_VEDU_VCPI_MEM_CTRL_T16_S */
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    mem_ctrl_s            : 26  ; /* [25..0]  */
...
} U_VEDU_VCPI_MEM_CTRL_T16_S;

/* Define the union U_VEDU_VCPI_VENC_MID */
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    venc_mid              : 6   ; /* [5..0]  */
        unsigned int    Reserved_123          : 26  ; /* [31..6]  */
    } bits;

    /* Define an unsigned member */
    unsigned int    u32;

} U_VEDU_VCPI_VENC_MID;
...
/* Define the union U_FUNC_INTRA0_DFX_CU8_FSM */
typedef union
{
    /* Define the struct bits */
    struct
    {
        ...
        unsigned int    Reserved_28           : 27  ; /* [31..5]  */
    } bits;

    /* Define an unsigned member */
    unsigned int    u32;

} U_FUNC_INTRA0_DFX_CU8_FSM;

/* Define the union U_FUNC_INTRA0_DFX_CU16_FSM */
typedef union
{
    /* Define the struct bits */
    struct
...
} U_FUNC_INTRA0_DFX_CU16_FSM;

/* Define the union U_FUNC_INTRA0_DFX_CU32_FSM */
typedef union
{
    /* Define the struct bits */
    struct
    {
        ...
        unsigned int    Reserved_30           : 27  ; /* [31..5]  */
    } bits;

    /* Define an unsigned member */
    unsigned int    u32;

} U_FUNC_INTRA0_DFX_CU32_FSM;

/* Define the union U_FUNC_INTRA0_DFX_PCM_PWR__TYPE */
typedef union
{
    /* Define the struct bits */
    struct
    {
        ...
        unsigned int    Reserved_34           : 3   ; /* [3..1]  */
        unsigned int    dfx_lpw               : 1   ; /* [4]  */
        unsigned int    Reserved_33           : 3   ; /* [7..5]  */
        unsigned int    dfx_frm_type          : 2   ; /* [9..8]  */
        unsigned int    Reserved_32           : 22  ; /* [31..10]  */
    } bits;

    /* Define an unsigned member */
    unsigned int    u32;

} U_FUNC_INTRA0_DFX_PCM_PWR__TYPE;

/* Define the union U_FUNC_INTRA0_DFX_HEAD_BIT_WEIGHT */
typedef union
{
    /* Define the struct bits */
    struct
...
} U_FUNC_INTRA0_DFX_HEAD_BIT_WEIGHT;

/* Define the union U_FUNC_INTRA0_DFX_RDO_WEIGHT */
typedef union
{
    /* Define the struct bits */
    struct
...
} U_FUNC_INTRA0_DFX_RDO_WEIGHT;

/* Define the union U_FUNC_INTRA0_DFX_BLK_CNT */
typedef union
{
    /* Define the struct bits */
    struct
    {
        ...
        unsigned int    Reserved_39           : 2   ; /* [15..14]  */
        unsigned int    dfx_cu16_idx          : 4   ; /* [19..16]  */
        unsigned int    Reserved_38           : 4   ; /* [23..20]  */
        unsigned int    dfx_cu32_idx          : 2   ; /* [25..24]  */
        unsigned int    Reserved_37           : 6   ; /* [31..26]  */
    } bits;

    /* Define an unsigned member */
    unsigned int    u32;

} U_FUNC_INTRA0_DFX_BLK_CNT;
...
typedef union
{
	...
	struct
	{
        ...
        unsigned int    ctx_racfg_ns     : 2   ; /* [27..26]  */
        unsigned int    ctx_wacfg_ns      : 2   ; /* [29..28]  */		
		unsigned int    Reserved_721    : 2  ; /* [31..30]  */
	} bits;
...
typedef union
{
	...
	{
		unsigned int    mem_ctrl_s    : 26  ; /* [25..0]  */
		unsigned int    Reserved_1    : 6  ; /* [31..16]  */
	} bits;
...
typedef union
{
	...
	struct
	{
		...
		unsigned int    ptw_racfg_ns    : 1   ; /* [1]  */
		unsigned int    smr_ptw_qos    : 2   ; /* [3..2]  */
		unsigned int    smr_invld_en    : 1   ; /* [4]  */
		unsigned int    tbu_racfg_ns          : 2   ; /* [6..5]  */
		unsigned int    tbu_wacfg_ns          : 2   ; /* [8..7]  */
		unsigned int    tbu_alloc_en_ns       : 1   ; /* [9]  */
		unsigned int    Reserved_729    : 2   ; /* [11..10]  */
...
/* Define the union U_SMMU_GLB_ALLOC_ST */
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    glb_alloc_finish      : 1   ; /* [0]  */
...
typedef union
{
	...
	struct
	{
		...
		unsigned int    Reserved_746    : 15  ; /* [31..17]  */
	} bits;
...
typedef union
{
	...
	struct
	{
		...
		unsigned int    Reserved_39     : 16  ; /* [25..10]  */
        unsigned int    ctx_racfg_s     : 2   ; /* [27..26]  */
        unsigned int    ctx_wacfg_s     : 2   ; /* [29..28]  */
		unsigned int    Reserved_759    : 2  ; /* [31..30]  */
	} bits;
...
/* Define the union U_SMMU_SMRX_S1 */
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    Reserved_51           : 1   ; /* [0]  */
        unsigned int    ptw_racfg_s           : 1   ; /* [1]  */
        unsigned int    Reserved_50           : 3   ; /* [4..2]  */
        unsigned int    tbu_racfg_s           : 2   ; /* [6..5]  */
        unsigned int    tbu_wacfg_s           : 2   ; /* [8..7]  */
        unsigned int    tbu_alloc_en_s        : 1   ; /* [9]  */
        unsigned int    Reserved_49           : 22  ; /* [31..10]  */
    } bits;
...
typedef union
{
	...
	struct
	{
		...
		unsigned int    ptw_racfg_p    : 1   ; /* [1]  */
		unsigned int    smr_bypass_p    : 1   ; /* [2]  */
		unsigned int    Reserved_769    : 2   ; /* [4..3]  */
        unsigned int    tbu_racfg_p           : 2   ; /* [6..5]  */
        unsigned int    tbu_wacfg_p           : 2   ; /* [8..7]  */
        unsigned int    tbu_alloc_en_p        : 1   ; /* [9]  */
        unsigned int    Reserved_52           : 2   ; /* [11..10]  */
...
typedef union
{
	...
	struct
	{
		...
		unsigned int    Reserved_60     : 17  ; /* [25..9]  */
        unsigned int    ctx_racfg_p     : 2   ; /* [27..26]  */
        unsigned int    ctx_wacfg_p     : 2   ; /* [29..28]  */
		unsigned int    Reserved_776    : 2  ; /* [31..30]  */
	} bits;
...
typedef struct
{
    ...
    volatile U_VEDU_VCPI_MEM_CTRL_T16_S   VEDU_VCPI_MEM_CTRL_T16_S;
    volatile U_VEDU_VCPI_VENC_MID   VEDU_VCPI_VENC_MID;
	volatile unsigned int    RESERVED_VCPI[8];
	...
	volatile U_FUNC_INTRA0_DFX_CU8_FSM   FUNC_INTRA0_DFX_CU8_FSM;
    volatile U_FUNC_INTRA0_DFX_CU16_FSM   FUNC_INTRA0_DFX_CU16_FSM;
    volatile U_FUNC_INTRA0_DFX_CU32_FSM   FUNC_INTRA0_DFX_CU32_FSM;
    volatile unsigned int           RESERVED_FUNC_INTRA2;
    volatile U_FUNC_INTRA0_DFX_PCM_PWR__TYPE   FUNC_INTRA0_DFX_PCM_PWR__TYPE;
    volatile U_FUNC_INTRA0_DFX_HEAD_BIT_WEIGHT   FUNC_INTRA0_DFX_HEAD_BIT_WEIGHT;
    volatile U_FUNC_INTRA0_DFX_RDO_WEIGHT   FUNC_INTRA0_DFX_RDO_WEIGHT;
    volatile U_FUNC_INTRA0_DFX_BLK_CNT   FUNC_INTRA0_DFX_BLK_CNT;
	volatile unsigned int    RESERVED_FUNC_INTRA0[8];
	...
	volatile unsigned int           SMMU_MAIR_NS[54];
	...
	volatile unsigned int           SMMU_MAIR_S[2];
    volatile U_SMMU_SMRX_S1         SMMU_SMRX_S1[15920];
...
typedef struct
{
    ...
    volatile U_SMMU_SMRX_S1         SMMU_SMRX_S1;
