...
PINHOLE_ALS_PARA_TABLE pinhole_als_para_diff_tp_color_table[] = {
	...
	{PAR, V4, APDS9922, TS_PANEL_UNKNOWN, {867, 429, 256, 318, 550, 0, 918, 1699, 15000, 0}},
...
RPR531_ALS_PARA_TABLE rpr531_als_para_diff_tp_color_table[] ={
	...
	{COR, V4, TS_PANEL_UNKNOWN,
		{7218, 2922, 2212, 2212, 5035, 1389, 892, 750, 700, 1554, 2200, 2500, 732, 106, 15000, 100}},
...
TSL2591_ALS_PARA_TABLE tsl2591_als_para_diff_tp_color_table[] = {
	...
	{VCE, V3, TS_PANEL_UNKNOWN, BLACK,
	 {21864, 1555, 3670, 6423, 3198, 7292, 500, 0, 555, 150, 138, 24, 5000, 200} },

        {VCE, V3, TS_PANEL_UNKNOWN, WHITE,
         {7692, 1580, 3250, 5850, 2127, 4255, 488, 0, 630, 270, 1503, 233, 5000, 200} },
};

BH1726_ALS_PARA_TABLE bh1726_als_para_diff_tp_color_table[] = {
	{TNY, V4, TS_PANEL_UNKNOWN, BLACK,
	 {1099, 1230, 799, 799, 384, 521, 183, 183, 750, 1100, 4345, 4345, 4104, 640, 30000, 100} },

	{EVER, V3, TS_PANEL_UNKNOWN, BLACK,
	 {1172, 802, 695, 325, 976, 160, 107, 13, 453, 1994, 3937, 24990, 2591, 392, 30000, 0} },
};
