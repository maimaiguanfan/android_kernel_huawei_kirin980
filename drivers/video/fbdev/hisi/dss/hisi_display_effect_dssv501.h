...
#ifndef EFFECT_DSSV501_H
#define EFFECT_DSSV501_H
...
struct gamma_info {
    ...
    compat_pointer(gamma_r_table_pre); //add for 980
    compat_pointer(gamma_g_table_pre);//add for 980
    compat_pointer(gamma_b_table_pre);//add for 980
};
