...
//360 KB = HWC_330KB + MDC_30KB
#define MMBUF_SIZE_MAX	 (330 * 1024)
#define MMBUF_SIZE_MDC_MAX	 (30 * 1024)
...
#define HISIFB_DSS_PLATFORM_TYPE  (FB_ACCEL_DSSV501 | FB_ACCEL_PLATFORM_TYPE_ASIC)
