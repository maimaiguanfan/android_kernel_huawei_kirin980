...
{
	outp32(hisifd->noc_dss_base + 0xc, 0x1);
	outp32(hisifd->noc_dss_base + 0x10, 0x1000);
	outp32(hisifd->noc_dss_base + 0x14, 0x20);
	outp32(hisifd->noc_dss_base + 0x18, 0x1);

	outp32(hisifd->noc_dss_base + 0x8c, 0x1);
	outp32(hisifd->noc_dss_base + 0x90, 0x1000);
	outp32(hisifd->noc_dss_base + 0x94, 0x20);
	outp32(hisifd->noc_dss_base + 0x98, 0x1);

	outp32(hisifd->noc_dss_base + 0x10c, 0x1);
	outp32(hisifd->noc_dss_base + 0x110, 0x1000);
	outp32(hisifd->noc_dss_base + 0x114, 0x20);
	outp32(hisifd->noc_dss_base + 0x118, 0x1);

	outp32(hisifd->noc_dss_base + 0x18c, 0x1);
	outp32(hisifd->noc_dss_base + 0x190, 0x1000);
	outp32(hisifd->noc_dss_base + 0x194, 0x20);
	outp32(hisifd->noc_dss_base + 0x198, 0x1);
}
...
void hisi_dss_arsr2p_init(char __iomem * arsr2p_base, dss_arsr2p_t *s_arsr2p)
{
	...
	s_arsr2p->arsr2p_effect.shoot_cfg1 = (372 | (20 << 16)); //(shootslop1 | (shootgradalpha << 16))
	s_arsr2p->arsr2p_effect.shoot_cfg2 = ((8 << 16) | (-80 & 0x7ff)); //(shootgradsubthrl | (shootgradsubthrh << 16)), default shootgradsubthrh is 0
	s_arsr2p->arsr2p_effect.shoot_cfg3 = 15;//shootshpratio, needconfirm
	...
	s_arsr2p->arsr2p_effect.sharp_cfg3 = (128 | (192 << 16)); //(shptocuthigh0 ) | (shptocuthigh1 << 16)
	s_arsr2p->arsr2p_effect.sharp_cfg4 = (40 | (160 << 16)); //(sharpshootctrll | (sharpshootctrlh << 16)
	//s_arsr2p->arsr2p_effect.sharp_cfg5 = 0;//2500; //skinadd2
	s_arsr2p->arsr2p_effect.sharp_cfg6 = (8 | (8 << 16)); //(blendshshootctrl  | (sharpcoring << 16)
	s_arsr2p->arsr2p_effect.sharp_cfg7 = (10 | (6 << 8));// | (6 << 16) | (12 << 24)); //(skinthresh | (skinthresl << 8) | (shctrllowstart << 16) | (shctrlhighend << 24))
	s_arsr2p->arsr2p_effect.sharp_cfg8 = (16 | (160 << 8)); //(linearshratiol | (linearshratioh << 8))
	...
	s_arsr2p->arsr2p_effect.texturw_analysts = (64 | (80 << 16)); //(difflow | (diffhigh << 16))
	s_arsr2p->arsr2p_effect.intplshootctrl = (8); //(intplshootctrl)
	s_arsr2p->arsr2p_effect.sharp_level = 0x20002;
	s_arsr2p->arsr2p_effect.sharp_gain_low = 0x3C0078;
	s_arsr2p->arsr2p_effect.sharp_gain_mid = 0x6400C8;
	s_arsr2p->arsr2p_effect.sharp_gain_high = 0x5000A0;
	s_arsr2p->arsr2p_effect.sharp_gainctrl_sloph_mf = 0x280;
	s_arsr2p->arsr2p_effect.sharp_gainctrl_slopl_mf = 0x1400;
	s_arsr2p->arsr2p_effect.sharp_gainctrl_sloph_hf = 0x140;
	s_arsr2p->arsr2p_effect.sharp_gainctrl_slopl_hf = 0xA00;
	s_arsr2p->arsr2p_effect.sharp_mf_lmt = 0x40;
	s_arsr2p->arsr2p_effect.sharp_gain_mf = 0x12C012C;
	s_arsr2p->arsr2p_effect.sharp_mf_b = 0;
	s_arsr2p->arsr2p_effect.sharp_hf_lmt = 0x80;
	s_arsr2p->arsr2p_effect.sharp_gain_hf = 0x104012C;
	s_arsr2p->arsr2p_effect.sharp_hf_b = 0x1400;
	s_arsr2p->arsr2p_effect.sharp_lf_ctrl = 0x100010;
	s_arsr2p->arsr2p_effect.sharp_lf_var = 0x1800080;
	s_arsr2p->arsr2p_effect.sharp_lf_ctrl_slop = 0;
	s_arsr2p->arsr2p_effect.sharp_hf_select = 0;
	s_arsr2p->arsr2p_effect.sharp_cfg2_h = 0x10000C0;
	s_arsr2p->arsr2p_effect.sharp_cfg2_l = 0x200010;
	...
	s_arsr2p->arsr2p_effect_scale_up.shoot_cfg1 = (372 | (20 << 16)); //(shootslop1 | (shootgradalpha << 16))
	s_arsr2p->arsr2p_effect_scale_up.shoot_cfg2 = ((8 << 16) | (-80 & 0x7ff)); //(shootgradsubthrl | (shootgradsubthrh << 16)), default shootgradsubthrh is 0
	s_arsr2p->arsr2p_effect_scale_up.shoot_cfg3 = 15;//shootshpratio, needconfirm
	...
	s_arsr2p->arsr2p_effect_scale_up.sharp_cfg3 = (128 | (192 << 16)); //(shptocuthigh0 ) | (shptocuthigh1 << 16)
	s_arsr2p->arsr2p_effect_scale_up.sharp_cfg4 = (40 | (160 << 16)); //(sharpshootctrll | (sharpshootctrlh << 16)
	//s_arsr2p->arsr2p_effect_scale_up.sharp_cfg5 = 0;//2500; //skinadd2
	s_arsr2p->arsr2p_effect_scale_up.sharp_cfg6 = (8 | (8<< 16)); //(blendshshootctrl  | (sharpcoring << 16)
	s_arsr2p->arsr2p_effect_scale_up.sharp_cfg7 = (10 | (6 << 8));// | (6 << 16) | (12 << 24)); //(skinthresh | (skinthresl << 8) | (shctrllowstart << 16) | (shctrlhighend << 24))
	s_arsr2p->arsr2p_effect_scale_up.sharp_cfg8 = (16 | (160 << 8)); //(linearshratiol | (linearshratioh << 8))
	...
	s_arsr2p->arsr2p_effect_scale_up.texturw_analysts = (64 | (80 << 16)); //(difflow | (diffhigh << 16))
	s_arsr2p->arsr2p_effect_scale_up.intplshootctrl = (8); //(intplshootctrl)
	s_arsr2p->arsr2p_effect_scale_up.sharp_level = 0x20002;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gain_low = 0x3C0078;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gain_mid = 0x6400C8;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gain_high = 0x5000A0;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gainctrl_sloph_mf = 0x280;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gainctrl_slopl_mf = 0x1400;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gainctrl_sloph_hf = 0x140;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gainctrl_slopl_hf = 0xA00;
	s_arsr2p->arsr2p_effect_scale_up.sharp_mf_lmt = 0x40;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gain_mf = 0x12C012C;
	s_arsr2p->arsr2p_effect_scale_up.sharp_mf_b = 0;
	s_arsr2p->arsr2p_effect_scale_up.sharp_hf_lmt = 0x80;
	s_arsr2p->arsr2p_effect_scale_up.sharp_gain_hf = 0x104012C;
	s_arsr2p->arsr2p_effect_scale_up.sharp_hf_b = 0x1400;
	s_arsr2p->arsr2p_effect_scale_up.sharp_lf_ctrl = 0x100010;
	s_arsr2p->arsr2p_effect_scale_up.sharp_lf_var = 0x1800080;
	s_arsr2p->arsr2p_effect_scale_up.sharp_lf_ctrl_slop = 0;
	s_arsr2p->arsr2p_effect_scale_up.sharp_hf_select = 0;
	s_arsr2p->arsr2p_effect_scale_up.sharp_cfg2_h = 0x10000C0;
	s_arsr2p->arsr2p_effect_scale_up.sharp_cfg2_l = 0x200010;
	...
	s_arsr2p->arsr2p_effect_scale_down.shoot_cfg1 = (372 | (20 << 16)); //(shootslop1 | (shootgradalpha << 16))
	s_arsr2p->arsr2p_effect_scale_down.shoot_cfg2 = ((8 << 16) | (-80 & 0x7ff)); //(shootgradsubthrl | (shootgradsubthrh << 16)), default shootgradsubthrh is 0
	s_arsr2p->arsr2p_effect_scale_down.shoot_cfg3 = 15;//shootshpratio, needconfirm
	...
	s_arsr2p->arsr2p_effect_scale_down.sharp_cfg3 = (128 | (192 << 16)); //(shptocuthigh0 ) | (shptocuthigh1 << 16)
	s_arsr2p->arsr2p_effect_scale_down.sharp_cfg4 = (40 | (160 << 16)); //(sharpshootctrll | (sharpshootctrlh << 16)
	//s_arsr2p->arsr2p_effect_scale_down.sharp_cfg5 = 0;//2500;  //skinadd2
	s_arsr2p->arsr2p_effect_scale_down.sharp_cfg6 = (8 | (8 << 16)); //(blendshshootctrl  | (sharpcoring << 16)
	...
	s_arsr2p->arsr2p_effect_scale_down.sharp_cfg8 = (16 | (160 << 8)); //(linearshratiol | (linearshratioh << 8))
	...
	s_arsr2p->arsr2p_effect_scale_down.texturw_analysts = (64 | (80 << 16)); //(difflow | (diffhigh << 16))
	s_arsr2p->arsr2p_effect_scale_down.intplshootctrl = (8); //(intplshootctrl)
	s_arsr2p->arsr2p_effect_scale_down.sharp_level = 0x20002;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gain_low = 0x3C0078;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gain_mid = 0x6400C8;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gain_high = 0x5000A0;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gainctrl_sloph_mf = 0x280;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gainctrl_slopl_mf = 0x1400;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gainctrl_sloph_hf = 0x140;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gainctrl_slopl_hf = 0xA00;
	s_arsr2p->arsr2p_effect_scale_down.sharp_mf_lmt = 0x40;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gain_mf = 0x12C012C;
	s_arsr2p->arsr2p_effect_scale_down.sharp_mf_b = 0;
	s_arsr2p->arsr2p_effect_scale_down.sharp_hf_lmt = 0x80;
	s_arsr2p->arsr2p_effect_scale_down.sharp_gain_hf = 0x104012C;
	s_arsr2p->arsr2p_effect_scale_down.sharp_hf_b = 0x1400;
	s_arsr2p->arsr2p_effect_scale_down.sharp_lf_ctrl = 0x100010;
	s_arsr2p->arsr2p_effect_scale_down.sharp_lf_var = 0x1800080;
	s_arsr2p->arsr2p_effect_scale_down.sharp_lf_ctrl_slop = 0;
	s_arsr2p->arsr2p_effect_scale_down.sharp_hf_select = 0;
	s_arsr2p->arsr2p_effect_scale_down.sharp_cfg2_h = 0x10000C0;
	s_arsr2p->arsr2p_effect_scale_down.sharp_cfg2_l = 0x200010;
